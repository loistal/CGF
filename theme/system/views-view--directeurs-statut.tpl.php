<?php
/*
Template personnalisé pour l'affichage des directeurs du statut visible sur "L'équipe du statut" 
*/
...
<div class="row">
  ...
  <div class="col-sm-8">
    <div class="thumbnail profil text-center ">
      <div class="row-fluid">
        <div class="col-sm-5"> 
         <?php if ( count($directeur->field_photo) == 0) { ?>
       ...
       <div class="col-sm-6">
        ...
        <div class="text-left">
         ...
         <blockquote class="domaines text-left">En charge <?php echo ($directeur->field_en_charges_des_domaines['und'][0]['safe_value']) ?></blockquote>

         
         <div class="email text-left row"><span class="col-sm-2">Email :</span>  <?php echo $directeur_email ?></div>
         <div class=" telephone text-left row"><span class="col-sm-2">Tél. :</span>  <?php if(count($directeur->field_telephone) != 0)echo format_directeur_phone($directeur->field_telephone['und'][0]['safe_value']); ?></div>
...
<div class="col-sm-4">
  <div class="thumbnail profil text-center">
    ...
    <p class="domaines ">En charge <?php  if(count($adjoint->field_en_charges_des_domaines) != 0) echo ($adjoint->field_en_charges_des_domaines['und'][0]['safe_value']);?></p>
    <div class="row-fluid">
      <div class="col-sm-6 email adjoint text-left"><?php echo $adjoint_email ?></div>
      <div class="col-sm-4 telephone pull-right"><?php if(count($adjoint->field_telephone) != 0)echo format_directeur_phone($adjoint->field_telephone['und'][0]['safe_value']); ?></div>
    </div>
    <div class="clearfix"></div>
  </div>
</div>
    ...
    <div class="row-fluid">
      ...
      <div class="col-sm-6">
        ...
        <div class="text-left">
          ...
          <div class="email text-left row"><span class="col-sm-2">Email :</span>  <?php echo $directeur_email ?></div>
          <div class=" telephone text-left row"><span class="col-sm-2">Tél. :</span>  <?php echo (empty($directeur->field_telephone['und'][0]['safe_value']))? "" : format_directeur_phone($directeur->field_telephone['und'][0]['safe_value']); ?></div>
