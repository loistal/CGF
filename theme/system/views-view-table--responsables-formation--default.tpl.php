    ...
    <div class="col-sm-4">
      <div class="thumbnail profil text-center">
        ...
        <div class="caption">
          ...
          <p class="domaines"><?php  echo ($profile->field_en_charges_des_domaines['und'][0]['safe_value']) ?></p>
          <div class="row-fluid">
            <div class="col-sm-6 email text-left" <?php if(strlen($email) > 30 ) { ?> style="font-size:90%" <?php } ?> > <?php echo $email; ?> </div>
            <div class="col-sm-6 telephone text-right"><?php echo format_responsable_phone($profile->field_telephone['und'][0]['safe_value']); ?></div>
          </div>
        </div>
      </div>
    </div>
